...
exports.default = (path, styleModuleImportMap, styleNameAttribute, options) => {
  ...
  if (classNameAttribute) {
    if ((0, _babelTypes.isStringLiteral)(classNameAttribute.value)) {
      ...
      classNameAttribute.value.expression = (0, _conditionalClassMerge2.default)(classNameAttribute.value.expression, (0, _babelTypes.stringLiteral)(resolvedStyleName), options.styleNameFirst);
    } else {
