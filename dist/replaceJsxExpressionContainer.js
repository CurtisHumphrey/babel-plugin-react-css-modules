...
exports.default = (t, path, styleNameAttribute, importedHelperIndentifier, styleModuleImportMapIdentifier, options) => {
  ...
  if (classNameAttribute) {
    if ((0, _babelTypes.isStringLiteral)(classNameAttribute.value)) {
      path.node.openingElement.attributes.push((0, _babelTypes.jSXAttribute)((0, _babelTypes.jSXIdentifier)('className'), (0, _babelTypes.jSXExpressionContainer)(options.styleNameFirst ? (0, _babelTypes.binaryExpression)('+', styleNameExpression, t.stringLiteral(' ' + classNameAttribute.value.value)) : (0, _babelTypes.binaryExpression)('+', t.stringLiteral(classNameAttribute.value.value + ' '), styleNameExpression))));
    } else if ((0, _babelTypes.isJSXExpressionContainer)(classNameAttribute.value)) {
      path.node.openingElement.attributes.push((0, _babelTypes.jSXAttribute)((0, _babelTypes.jSXIdentifier)('className'), (0, _babelTypes.jSXExpressionContainer)((0, _conditionalClassMerge2.default)(classNameAttribute.value.expression, styleNameExpression, options.styleNameFirst))));
    } else {
